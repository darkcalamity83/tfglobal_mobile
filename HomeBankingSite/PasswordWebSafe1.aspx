...
<head runat="server">
   ...
   <!-- <meta name="viewport" content="width=device-width, initial-scale=1.0,user-scalable=1.5;" />-->
    <meta name="viewport" content="width=device-width,user-scalable=1.5;" />
...
<body>
  <form id="frm" runat="server" style="height: 100%; width: auto%">
        ...
        <tr>
            <td width="22%" style="vertical-align:top;">
               ...
               <div id="wHelp2" style="display: none; height:300px;">
                    <iframe width="auto" height="auto" src="Help/Password.htm"></iframe>
               </div>
            </td>
