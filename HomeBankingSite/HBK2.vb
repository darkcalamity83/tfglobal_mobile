                ...
                If (Acct.Permission <> EHbkPermission.Low OrElse Acct.SubAccts Is Nothing) Then
                    ...
                    Else
                        ...
                        If (Acct.Permission <> EHbkPermission.Low) Then
                            ...
                            Writer.Write("<table cellpadding='0' cellspacing='0'>")
                            Writer.Write("<tr><th width='20%'>Account</th><th width='15%'>Balance</th><th width='15%'>Available</th><th width='20%'>Next Due Date</th><th width='15%'>Payment Amt</th><th width='15%'>Pay Off</th></tr>")
