...
<body>
    ...
    <table cellpadding="0" cellspacing="0" style="height: 100%; width: 100%; background-color:#000066;" class="WinBlueB">
        <tr>
            <td width="22%" style="vertical-align: top;">
               ...
               <div id="wHelp2" style="display: none; height:250px;">
                    <iframe width="100%" height="100%" src="Help/Login.htm" scrolling="no"></iframe>
               </div>
            </td>
